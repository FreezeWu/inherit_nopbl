$PBExportHeader$n_cst_inh401_l2_auto.sru
forward
global type n_cst_inh401_l2_auto from n_cst_inh401_l1_auto
end type
end forward
...
on n_cst_inh401_l2_auto.create
call super::create
end on

on n_cst_inh401_l2_auto.destroy
call super::destroy
end on
