$PBExportHeader$inh406_svoincvo.sra
$PBExportComments$Generated Application Object
forward
global type inh406_svoincvo from application
end type
...
string  gs_WinName[] = {"w_inh406w01_instancevar","w_inh406w02_property","w_inh406w03_event"}
//END_GLOBALVAR
end variables

global type inh406_svoincvo from application
string appname = "inh406_svoincvo"
event ue_cotopen ( string as_commandline )
end type
global inh406_svoincvo inh406_svoincvo
...
elseif gb_COTDBConnected and gb_COTAutoRun then
	...
	for i=1 to li_WinCount
		 //OpenSheet(lw_Window[i], ls_WinName[i], w_mdi, 1, Original!)
		  //OpenSheet(lw_Window[i], ls_WinName[i], w_mdi, 1, Original!)
		 choose case lower(ls_WinName[i])
			case "w_inh406w01_instancevar"
				OpenSheet(w_inh406w01_instancevar, w_mdi, 1, Original!)
				lw_Window[i] = w_inh406w01_instancevar
			case "w_inh406w02_property"
				OpenSheet(w_inh406w02_property, w_mdi, 1, Original!)
				lw_Window[i] = w_inh406w02_property
			case "w_inh406w03_event"	
				OpenSheet(w_inh406w03_event, w_mdi, 1, Original!)
				lw_Window[i] = w_inh406w03_event
			case else
				continue
		end choose
...
on inh406_svoincvo.create
appname="inh406_svoincvo"
