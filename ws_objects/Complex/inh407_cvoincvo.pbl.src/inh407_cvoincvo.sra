$PBExportHeader$inh407_cvoincvo.sra
$PBExportComments$Generated Application Object
forward
global type inh407_cvoincvo from application
end type
...
string  gs_WinName[] = {"w_inh407w01_instance","w_inh407w02_property","w_inh407w03_event"}
//END_GLOBALVAR
end variables

global type inh407_cvoincvo from application
string appname = "inh407_cvoincvo"
event ue_cotopen ( string as_commandline )
end type
global inh407_cvoincvo inh407_cvoincvo
	...
	for i=1 to li_WinCount
		// OpenSheet(lw_Window[i], ls_WinName[i], w_mdi, 1, Original!)
		 ...
		 choose case lower(ls_WinName[i])
			case "w_inh407w01_instance"
				OpenSheet(w_inh407w01_instance, w_mdi, 1, Original!)
				lw_Window[i] = w_inh407w01_instance
			case "w_inh407w02_property"
				OpenSheet(w_inh407w02_property, w_mdi, 1, Original!)
				lw_Window[i] = w_inh407w02_property
			case "w_inh407w03_event"	
				OpenSheet(w_inh407w03_event, w_mdi, 1, Original!)
				lw_Window[i] = w_inh407w03_event
			case else
				continue
		end choose
...
on inh407_cvoincvo.create
appname="inh407_cvoincvo"
