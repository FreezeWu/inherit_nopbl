$PBExportHeader$w_inh403w03_l3_nvoinwin.srw
forward
global type w_inh403w03_l3_nvoinwin from w_inh403w02_l2_nvoinwin
end type
end forward

global type w_inh403w03_l3_nvoinwin from w_inh403w02_l2_nvoinwin
end type
global w_inh403w03_l3_nvoinwin w_inh403w03_l3_nvoinwin

type variables
//Declare Nvo L3
n_cst_inh403_L1_auto		invo_W03_autoL1
n_cst_inh403_L2_auto		invo_W03_autoL2
n_cst_inh403_L3_auto		invo_W03_autoL3

n_cst_inh403_L1_unauto		invo_W03_unautoL1
n_cst_inh403_L2_unauto		invo_W03_unautoL2
n_cst_inh403_L3_unauto		invo_W03_unautoL3
end variables
...
lb_items.additem("INH403W03P001: Calling Nvo Instance Variables(Level 1)")
lb_items.additem("INH403W03P002: Calling Nvo Instance Variables(Level 2)")
lb_items.additem("INH403W03P003: Calling Nvo Instance Variables(Level 3)")
end subroutine
...
Choose Case ls_item
	...
	Case 'INH403W03P003'
		If ab_execute Then
			...
			Wf_Output('Describe   : ' + ls_descript, False)
			//auto instantiation
			ls_Original[1]=invo_W03_autoL1.is_String
			Wf_Output('First Get  : invo_W03_autoL1.is_String = ~"' + invo_W03_autoL1.is_String + '~"', False)
			invo_W03_autoL1.is_String = 'Set ' + invo_W03_autoL1.is_String
			Wf_Output('Second Get : invo_W03_autoL1.is_String = ~"' + invo_W03_autoL1.is_String + '~"', False)
			
			ls_Original[2]=invo_W03_autoL2.is_String
			Wf_Output('First Get  : invo_W03_autoL2.is_String = ~"' + invo_W03_autoL2.is_String + '~"', False)
			invo_W03_autoL2.is_String = 'Set ' + invo_W03_autoL2.is_String
			Wf_Output('Second Get : invo_W03_autoL2.is_String = ~"' + invo_W03_autoL2.is_String + '~"', False)
			
			ls_Original[3]=invo_W03_autoL3.is_String
			Wf_Output('First Get  : invo_W03_autoL3.is_String = ~"' + invo_W03_autoL3.is_String + '~"', False)
			invo_W03_autoL3.is_String = 'Set ' + invo_W03_autoL3.is_String
			Wf_Output('Second Get : invo_W03_autoL3.is_String = ~"' + invo_W03_autoL3.is_String + '~"', False)
			//unauto instantiation
			ls_Original[4]=invo_W03_unautoL1.is_String
			Wf_Output('First Get  : invo_W03_unautoL1.is_String = ~"' + invo_W03_unautoL1.is_String + '~"', False)
			invo_W03_unautoL1.is_String = 'Set ' + invo_W03_unautoL1.is_String
			Wf_Output('Second Get : invo_W03_unautoL1.is_String = ~"' + invo_W03_unautoL1.is_String + '~"', False)
			
			ls_Original[5]=invo_W03_unautoL2.is_String
			Wf_Output('First Get  : invo_W03_unautoL2.is_String = ~"' + invo_W03_unautoL2.is_String + '~"', False)
			invo_W03_unautoL2.is_String = 'Set ' + invo_W03_unautoL2.is_String
			Wf_Output('Second Get : invo_W03_unautoL2.is_String = ~"' + invo_W03_unautoL2.is_String + '~"', False)
			
			ls_Original[6]=invo_W03_unautoL3.is_String
			Wf_Output('First Get  : invo_W03_unautoL3.is_String = ~"' + invo_W03_unautoL3.is_String + '~"', False)
			invo_W03_unautoL3.is_String = 'Set ' + invo_W03_unautoL3.is_String
			Wf_Output('Second Get : invo_W03_unautoL3.is_String = ~"' + invo_W03_unautoL3.is_String + '~"', False)
		//=======================================================================
		//author:lujianhua
		//Add Code: Restore the original value
		invo_W03_autoL1.is_String = ls_Original[1]
		invo_W03_autoL2.is_String = ls_Original[2]
		invo_W03_autoL3.is_String = ls_Original[3]
		invo_W03_unautoL1.is_String = ls_Original[4]
		invo_W03_unautoL2.is_String = ls_Original[5]
		invo_W03_unautoL3.is_String = ls_Original[6]
		//=======================================================================
		Else
			...
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                                                       ")
			wf_scriptview("//auto instantiation                                                                                  ")
			wf_scriptview("Wf_Output('First Get  : invo_W03_autoL1.is_String = ~"' + invo_W03_autoL1.is_String + '~"', False)    ")
			wf_scriptview("invo_W03_autoL1.is_String = 'Set ' + invo_W03_autoL1.is_String                                        ")
			wf_scriptview("Wf_Output('Second Get : invo_W03_autoL1.is_String = ~"' + invo_W03_autoL1.is_String + '~"', False)    ")
			wf_scriptview("                                                                                                      ")
			wf_scriptview("Wf_Output('First Get  : invo_W03_autoL2.is_String = ~"' + invo_W03_autoL2.is_String + '~"', False)    ")
			wf_scriptview("invo_W03_autoL2.is_String = 'Set ' + invo_W03_autoL2.is_String                                        ")
			wf_scriptview("Wf_Output('Second Get : invo_W03_autoL2.is_String = ~"' + invo_W03_autoL2.is_String + '~"', False)    ")
			wf_scriptview("                                                                                                      ")
			wf_scriptview("Wf_Output('First Get  : invo_W03_autoL3.is_String = ~"' + invo_W03_autoL3.is_String + '~"', False)    ")
			wf_scriptview("invo_W03_autoL3.is_String = 'Set ' + invo_W03_autoL3.is_String                                        ")
			wf_scriptview("Wf_Output('Second Get : invo_W03_autoL3.is_String = ~"' + invo_W03_autoL3.is_String + '~"', False)    ")
			wf_scriptview("//unauto instantiation                                                                                ")
			wf_scriptview("Wf_Output('First Get  : invo_W03_unautoL1.is_String = ~"' + invo_W03_unautoL1.is_String + '~"', False)")
			wf_scriptview("invo_W03_unautoL1.is_String = 'Set ' + invo_W03_unautoL1.is_String                                    ")
			wf_scriptview("Wf_Output('Second Get : invo_W03_unautoL1.is_String = ~"' + invo_W03_unautoL1.is_String + '~"', False)")
			wf_scriptview("                                                                                                      ")
			wf_scriptview("Wf_Output('First Get  : invo_W03_unautoL2.is_String = ~"' + invo_W03_unautoL2.is_String + '~"', False)")
			wf_scriptview("invo_W03_unautoL2.is_String = 'Set ' + invo_W03_unautoL2.is_String                                    ")
			wf_scriptview("Wf_Output('Second Get : invo_W03_unautoL2.is_String = ~"' + invo_W03_unautoL2.is_String + '~"', False)")
			wf_scriptview("                                                                                                      ")
			wf_scriptview("Wf_Output('First Get  : invo_W03_unautoL3.is_String = ~"' + invo_W03_unautoL3.is_String + '~"', False)")
			wf_scriptview("invo_W03_unautoL3.is_String = 'Set ' + invo_W03_unautoL3.is_String                                    ")
			wf_scriptview("Wf_Output('Second Get : invo_W03_unautoL3.is_String = ~"' + invo_W03_unautoL3.is_String + '~"', False)")
...
on w_inh403w03_l3_nvoinwin.create
call super::create
end on

on w_inh403w03_l3_nvoinwin.destroy
call super::destroy
end on

event ue_destroy;call super::ue_destroy;If IsValid(invo_W03_unautoL1) Then Destroy invo_W03_unautoL1
If IsValid(invo_W03_unautoL2) Then Destroy invo_W03_unautoL2
If IsValid(invo_W03_unautoL3) Then Destroy invo_W03_unautoL3
end event

event ue_instantiation;call super::ue_instantiation;If NOT IsValid(invo_W03_unautoL1) Then invo_W03_unautoL1 = Create n_cst_inh403_L1_unauto
If NOT IsValid(invo_W03_unautoL2) Then invo_W03_unautoL2 = Create n_cst_inh403_L2_unauto
If NOT IsValid(invo_W03_unautoL3) Then invo_W03_unautoL3 = Create n_cst_inh403_L3_unauto
end event

type cb_2 from w_inh403w02_l2_nvoinwin`cb_2 within w_inh403w03_l3_nvoinwin
end type

type cb_1 from w_inh403w02_l2_nvoinwin`cb_1 within w_inh403w03_l3_nvoinwin
end type

type cb_execute from w_inh403w02_l2_nvoinwin`cb_execute within w_inh403w03_l3_nvoinwin
end type

type lb_items from w_inh403w02_l2_nvoinwin`lb_items within w_inh403w03_l3_nvoinwin
end type

type cb_clear from w_inh403w02_l2_nvoinwin`cb_clear within w_inh403w03_l3_nvoinwin
end type

type cb_close from w_inh403w02_l2_nvoinwin`cb_close within w_inh403w03_l3_nvoinwin
end type

type mle_output from w_inh403w02_l2_nvoinwin`mle_output within w_inh403w03_l3_nvoinwin
end type

type mle_view from w_inh403w02_l2_nvoinwin`mle_view within w_inh403w03_l3_nvoinwin
end type

type gb_3 from w_inh403w02_l2_nvoinwin`gb_3 within w_inh403w03_l3_nvoinwin
end type

type gb_5 from w_inh403w02_l2_nvoinwin`gb_5 within w_inh403w03_l3_nvoinwin
end type

type mle_describe from w_inh403w02_l2_nvoinwin`mle_describe within w_inh403w03_l3_nvoinwin
end type

type gb_1 from w_inh403w02_l2_nvoinwin`gb_1 within w_inh403w03_l3_nvoinwin
end type

type gb_2 from w_inh403w02_l2_nvoinwin`gb_2 within w_inh403w03_l3_nvoinwin
end type
