$PBExportHeader$inh202_menuproperty.sra
$PBExportComments$Generated Application Object
forward
global type inh202_menuproperty from application
end type
...
string  gs_WinName[] = {"w_inh202w01_menupropertyl2","w_inh202w02_menupropertyl3"}
//END_GLOBALVAR
end variables

global type inh202_menuproperty from application
string appname = "inh202_menuproperty"
event ue_cotopen ( string as_commandline )
end type
global inh202_menuproperty inh202_menuproperty
...
on inh202_menuproperty.create
appname="inh202_menuproperty"
...
on inh202_menuproperty.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
