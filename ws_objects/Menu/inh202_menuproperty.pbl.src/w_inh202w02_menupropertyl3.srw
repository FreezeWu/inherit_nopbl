$PBExportHeader$w_inh202w02_menupropertyl3.srw
forward
global type w_inh202w02_menupropertyl3 from window
end type
type cb_3 from commandbutton within w_inh202w02_menupropertyl3
end type
type cb_2 from commandbutton within w_inh202w02_menupropertyl3
end type
type cb_execute from commandbutton within w_inh202w02_menupropertyl3
end type
type lb_items from listbox within w_inh202w02_menupropertyl3
end type
type cb_clear from commandbutton within w_inh202w02_menupropertyl3
end type
type cb_close from commandbutton within w_inh202w02_menupropertyl3
end type
type mle_output from multilineedit within w_inh202w02_menupropertyl3
end type
type mle_view from multilineedit within w_inh202w02_menupropertyl3
end type
type gb_3 from groupbox within w_inh202w02_menupropertyl3
end type
type gb_4 from groupbox within w_inh202w02_menupropertyl3
end type
type gb_5 from groupbox within w_inh202w02_menupropertyl3
end type
type mle_describe from multilineedit within w_inh202w02_menupropertyl3
end type
type gb_1 from groupbox within w_inh202w02_menupropertyl3
end type
end forward
...
string title = "Call Menu Property of Level 3"
string menuname = "m_inh202_l3"
...
global w_inh202w02_menupropertyl3 w_inh202w02_menupropertyl3
...
mle_describe.text += "2.Testing Purpose : Calling Menu Property of Level 3" // This must include
...
If this.MenuId <> m_inh202_l3 Then Return
...
Choose Case ls_item
	...
	Case 'INH202W02P001'
		If ab_execute Then
			...
			Wf_Output('Text Value: "' + lm_this.m_TestContents.m_text.text + '"', False)
		End If
	//Tag
	Case 'INH202W02P002'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('Text Value: "' + lm_this.m_TestContents.m_tag.tag + '"', False)
		End If
	//Visible
	Case 'INH202W02P003'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			If lm_this.m_TestContents.m_visible.Visible Then
				Wf_Output('lm_this.m_TestContents.m_visible.Visible: TRUE', False)
			Else
				Wf_Output('lm_this.m_TestContents.m_visible.Visible: FAlSE', False)
			End If
		End If
	//Enable
	Case 'INH202W02P004'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			If lm_this.m_TestContents.m_Enable.Enabled Then
				Wf_Output('lm_this.m_TestContents.m_Enable.Enabled: TRUE', False)
			Else
				Wf_Output('lm_this.m_TestContents.m_Enable.Enabled: FAlSE', False)
			End If
		End If
	//Checked
	Case 'INH202W02P005'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			If lm_this.m_TestContents.m_checked.Checked Then
				Wf_Output('lm_this.m_TestContents.m_Checked.Checked: TRUE', False)
			Else
				Wf_Output('lm_this.m_TestContents.m_Checked.Checked: FAlSE', False)
			End If
		End If
	//ToolbarItemName
	Case 'INH202W02P006'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('Text Value: "' + lm_this.m_TestContents.m_ToolbarItemName.ToolbarItemName + '"', False)
		End If
	//ToolbarItemDownName
	Case 'INH202W02P007'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('Text Value: "' + lm_this.m_TestContents.m_ToolbarItemDownName.ToolbarItemDownName + '"', False)
		End If
	//ToolbarItemText
	Case 'INH202W02P008'
		If ab_execute Then
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			Wf_Output('Text Value: "' + lm_this.m_TestContents.m_ToolbarItemText.ToolbarItemText + '"', False)
		End If
	Case Else
	 	MessageBox("Error","This Point Not Coding",Exclamation!)
End Choose
mle_View.Text = ""
wf_scriptview("//m_inh202L1 Modify Property")
wf_scriptview("m_visible.Visible = false                    ")
wf_scriptview("m_enable.Enabled = false                     ")
wf_scriptview("m_toolbaritemdownname.toolbaritemdownname = 'ArrangeTables5!'")
wf_scriptview("m_toolbaritemtext.toolbaritemtext = 'L1'")
wf_scriptview("")
wf_scriptview("//m_inh202L2 Modify Property")
wf_scriptview("m_tag.tag = 'L2'                        ")
wf_scriptview("m_enable.Enabled = true                     ")
wf_scriptview("m_toolbaritemname.toolbaritemname = 'AppRectangle!'")
wf_scriptview("m_toolbaritemtext.toolbaritemtext = 'L1L2'")
wf_scriptview("")
wf_scriptview("//m_inh202L3 Modify Property")
wf_scriptview("m_Checked.Checked = true                        ")
wf_scriptview("m_enable.Enabled = true                     ")
wf_scriptview("m_toolbaritemname.toolbaritemname = 'ArrangeIcons!'")
wf_scriptview("m_toolbaritemdownname.toolbaritemdownname = 'Asterisk!'")
wf_scriptview("m_toolbaritemtext.toolbaritemtext = 'L1L2L3'")
...
lb_items.additem("INH202W02P001: [ Text ] Property, Level 1,2,3 ALL NOT Modify")
lb_items.additem("INH202W02P002: [ Tag ] Property, Level 1,3 NOT Modify, Level 2 Modify")
lb_items.additem("INH202W02P003: [ Visible ] Property, Level 1 Modify, Level 2,3 NOT Modify")
lb_items.additem("INH202W02P004: [ Enable ] Property, Level 1,2 Modify, Level 3 NOT Modify")
lb_items.additem("INH202W02P005: [ Checked ] Property, Level 1,2 NOT Modify, Level 3 Modify")
lb_items.additem("INH202W02P006: [ ToolbarItemName ] Property, Level 1 NOT Modify, Level 2,3 Modify")
lb_items.additem("INH202W02P007: [ ToolbarItemDownName ] Property, Level 1,3 Modify, Level 2 NOT Modify")
lb_items.additem("INH202W02P008: [ ToolbarItemText ] Property, Level 1,2,3 All Modify")
end subroutine
...
on w_inh202w02_menupropertyl3.create
if this.MenuName = "m_inh202_l3" then this.MenuID = create m_inh202_l3
...
on w_inh202w02_menupropertyl3.destroy
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Menu Property View"
end type
