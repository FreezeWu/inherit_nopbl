$PBExportHeader$w_inh204w01_menufunction.srw
forward
global type w_inh204w01_menufunction from window
end type
type cb_3 from commandbutton within w_inh204w01_menufunction
end type
type cb_2 from commandbutton within w_inh204w01_menufunction
end type
type cb_execute from commandbutton within w_inh204w01_menufunction
end type
type lb_items from listbox within w_inh204w01_menufunction
end type
type cb_clear from commandbutton within w_inh204w01_menufunction
end type
type cb_close from commandbutton within w_inh204w01_menufunction
end type
type mle_output from multilineedit within w_inh204w01_menufunction
end type
type mle_view from multilineedit within w_inh204w01_menufunction
end type
type gb_3 from groupbox within w_inh204w01_menufunction
end type
type gb_4 from groupbox within w_inh204w01_menufunction
end type
type gb_5 from groupbox within w_inh204w01_menufunction
end type
type mle_describe from multilineedit within w_inh204w01_menufunction
end type
type gb_1 from groupbox within w_inh204w01_menufunction
end type
end forward
...
string title = "Call Menu Function"
string menuname = "m_inh204_l3"
...
global w_inh204w01_menufunction w_inh204w01_menufunction
...
mle_describe.text += "2.Testing Purpose : Calling Menu Function of Level 3" // This must include
...
If Menuid <> m_inh204_l3 Then Return
lm_this = MenuId
...
Choose Case ls_item
	...
	Case 'INH204W01P002'
		If ab_execute Then
			...
			lm_This.Function mf_point_2()

		Else
			wf_scriptview("//mf_point_2                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Function mf_point_2()                     ")
	...
	Case 'INH204W01P003'
		If ab_execute Then
			...
			lm_This.Function mf_point_3()

		Else
			wf_scriptview("//mf_point_3                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Function mf_point_3()                     ")
	...
	Case 'INH204W01P004'
		If ab_execute Then
			...
			lm_This.Function mf_point_4()

		Else
			wf_scriptview("//mf_point_4                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Function mf_point_4()                     ")
	...
	Case 'INH204W01P005'
		If ab_execute Then
			...
			lm_This.Function mf_point_5()

		Else
			wf_scriptview("//mf_point_5                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Function mf_point_5()                     ")
	...
	Case 'INH204W01P006'
		If ab_execute Then
			...
			lm_This.Function mf_point_6()

		Else
			wf_scriptview("//mf_point_6                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Function mf_point_6()                     ")
...
lb_items.additem("INH204W01P001: 1th Code,2th Code Override,3th Code Override.")
lb_items.additem("INH204W01P002: 1th Code,2th Code Override,3th NO Code.")
lb_items.additem("INH204W01P003: 1th Code,2th NO Code,3th NO Code")
lb_items.additem("INH204W01P004: 1th Code,2th Overload,3th Overload.")
lb_items.additem("INH204W01P005: 1th Code,2th Overload,3th Override 1th.")
lb_items.additem("INH204W01P006: 1th Undefine,2th Code, 3th NO Code.")
end subroutine
...
on w_inh204w01_menufunction.create
if this.MenuName = "m_inh204_l3" then this.MenuID = create m_inh204_l3
...
on w_inh204w01_menufunction.destroy
