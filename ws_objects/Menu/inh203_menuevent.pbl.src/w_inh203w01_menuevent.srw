$PBExportHeader$w_inh203w01_menuevent.srw
forward
global type w_inh203w01_menuevent from window
end type
type cb_3 from commandbutton within w_inh203w01_menuevent
end type
type cb_2 from commandbutton within w_inh203w01_menuevent
end type
type cb_execute from commandbutton within w_inh203w01_menuevent
end type
type lb_items from listbox within w_inh203w01_menuevent
end type
type cb_clear from commandbutton within w_inh203w01_menuevent
end type
type cb_close from commandbutton within w_inh203w01_menuevent
end type
type mle_output from multilineedit within w_inh203w01_menuevent
end type
type mle_view from multilineedit within w_inh203w01_menuevent
end type
type gb_3 from groupbox within w_inh203w01_menuevent
end type
type gb_4 from groupbox within w_inh203w01_menuevent
end type
type gb_5 from groupbox within w_inh203w01_menuevent
end type
type mle_describe from multilineedit within w_inh203w01_menuevent
end type
type gb_1 from groupbox within w_inh203w01_menuevent
end type
end forward
...
string title = "Call Menu Event"
string menuname = "m_inh203_l3"
...
global w_inh203w01_menuevent w_inh203w01_menuevent
...
mle_describe.text += "2.Testing Purpose : Calling Menu Event of Level 3" // This must include
...
/////////////////////////////////////////////////////////////////////
long			ll_pos
String 		ls_item, ls_descript, ls_Rtn
m_inh203_l3	lm_this

If Menuid <> m_inh203_l3 Then Return
lm_this = MenuId
...
Choose Case ls_item
	...
	Case 'INH203W01P002'
		If ab_execute Then
			...
			lm_This.Event ue_point_2()

		Else
			wf_scriptview("//ue_point_2                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Event ue_point_2()                     ")
	...
	Case 'INH203W01P003'
		If ab_execute Then
			...
			lm_This.Event ue_point_3()

		Else
			wf_scriptview("//ue_point_3                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Event ue_point_3()                     ")
	...
	Case 'INH203W01P004'
		If ab_execute Then
			...
			lm_This.Event ue_point_4()

		Else
			wf_scriptview("//ue_point_4                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Event ue_point_4()                     ")
	...
	Case 'INH203W01P005'
		If ab_execute Then
			...
			lm_This.Event ue_point_5()

		Else
			wf_scriptview("//ue_point_5                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Event ue_point_5()                     ")
	...
	Case 'INH203W01P006'
		If ab_execute Then
			...
			lm_This.Event ue_point_6()

		Else
			wf_scriptview("//ue_point_6                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Event ue_point_6()                     ")
	...
	Case 'INH203W01P007'
		If ab_execute Then
			...
			lm_This.Event ue_point_7()

		Else
			wf_scriptview("//ue_point_7                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)     ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)")
			wf_scriptview("                                               ")
			wf_scriptview("lm_This.Event ue_point_7()                     ")
...
lb_items.additem("INH203W01P001: 1th Code,2th Code Override,3th Code Override.")
lb_items.additem("INH203W01P002: 1th Code,2th Uncode Extend,3th Code Override.")
lb_items.additem("INH203W01P003: 1th Code,2th Code Extend,3th Code Extend.")
lb_items.additem("INH203W01P004: 1th Uncode,2th Code Override,3th Code Override.")
lb_items.additem("INH203W01P005: 1th Uncode,2th Uncode Extend,3th Code Override.")
lb_items.additem("INH203W01P006: 1th Uncode,2th Code Extend,3th Code Extend.")
lb_items.additem("INH203W01P007: 1th Undefine,2th Code,3th Code Extend.")
end subroutine
...
on w_inh203w01_menuevent.create
if this.MenuName = "m_inh203_l3" then this.MenuID = create m_inh203_l3
...
on w_inh203w01_menuevent.destroy
