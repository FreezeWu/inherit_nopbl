$PBExportHeader$inh203_menuevent.sra
$PBExportComments$Generated Application Object
forward
global type inh203_menuevent from application
end type
...
string  gs_WinName[] = {"w_inh203w01_menuevent"}
//END_GLOBALVAR
end variables

global type inh203_menuevent from application
string appname = "inh203_menuevent"
event ue_cotopen ( string as_commandline )
end type
global inh203_menuevent inh203_menuevent
...
//		 Close(lw_Window[i])
// OpenSheet(lw_Window[i], ls_WinName[i], w_mdi, 1, Original!)
		if lower( ls_WinName[i]) = 'w_inh203w01_menuevent' then
			OpenSheet(w_inh203w01_menuevent, w_mdi, 1, Original!)
			lw_Window[i] = w_inh203w01_menuevent
			lw_Window[i].TriggerEvent("ue_RunAll")
		 Close(lw_Window[i])
		end if
	next
...
on inh203_menuevent.create
appname="inh203_menuevent"
